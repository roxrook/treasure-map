...
/**
 * Class that represents a Logo-style turtle. The turtle starts off facing
 * north. A turtle can have a name, has a starting x and y position, has a
 * heading, has a width, has a height, has a visible flag, has a body color, can
 * have a shell color, and has a pen. The turtle will not go beyond the model
 * display or picture boundaries.
 * 
 * You can display this turtle in either a picture or in a class that implements
 * ModelDisplay.
 * 
...
public class SimpleTurtle {
	...
	/**
	 * Constructor that takes a model display and adds a turtle in the middle of
	 * it
	 * 
	 * @param display
	 *            the model display
	...
	/**
	 * Constructor that takes the picture to draw on and will appear in the
	 * middle
	 * 
	 * @param picture
	 *            the picture to draw on
	...
	public SimpleTurtle( Picture picture ) {
		...
		this.picture = picture;
		this.visible = true; // default is not to see the turtle
	}
	 ...
	 * 
	 * @param x
	 *            the x to turn towards
	 * @param y
	 *            the y to turn towards
	 */
	 ...
	 * 
	 * @param theModelDisplay
	 *            the model display to use
	 */
	...
	/**
	 * Method to hide the turtle (stop showing it) This doesn't affect the pen
	 * status
	 */
	public void hide() {
	...
	/**
	 * Method to update the display of this turtle and also check that the
	 * turtle is in the bounds
	 */
	 ...
	 * 
	 * @param pixels
	 *            the number of pixels to walk forward in the heading direction
	 */
	 ...
	 * 
	 * @param pixels
	 *            the number of pixels to walk backward
	 */
	...
	/**
	 * Method to turn the turtle the passed degrees use negative to turn left
	 * and pos to turn right
	 * 
	 * @param degrees
	...
	/**
	 * Method to draw a passed picture at the current turtle location and
	 * rotation in a picture or model display
	 * 
	 * @param dropPicture
	 *            the picture to drop
	 */
	...
	public synchronized void paintComponent( Graphics g ) {
		...
		if( visible ) {
			...
			g2.fillOval( xPos - quarterWidth, yPos - halfHeight
					- ( int )( height / 3 ), halfWidth, thirdHeight );
			g2.fillOval( xPos - ( 2 * thirdWidth ), yPos - thirdHeight,
					thirdWidth, thirdHeight );
			g2.fillOval( xPos - ( int )( 1.6 * thirdWidth ),
					yPos + thirdHeight, thirdWidth, thirdHeight );
	...
	public String toString() {
		return this.name + " turtle at " + this.xPos + ", " + this.yPos
