...
/**
 * Class to represent a 2d world that can hold turtles and display them
 * 
...
public class World extends JComponent implements ModelDisplay {
	...
	/**
	 * Constructor that takes a boolean to say if this world should be visible
	 * or not
	 * 
	 * @param visibleFlag
	 ...
	 * 
	 * @param visibleFlag
	 *            the flag to make the world visible or not
	 */
	...
	public String toString() {
		return "A " + getWidth() + " by " + getHeight() + " world with "
				+ turtleList.size() + " turtles in it.";
	}
